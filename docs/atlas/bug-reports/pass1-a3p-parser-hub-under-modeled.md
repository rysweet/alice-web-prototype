...
- Actual imports span multiple subsystems: `src/main.ts:3`, `src/project-system.ts:1-2`, `src/grading-pipeline.ts:1`, `src/hooks/place-object.ts:10`, and `src/server.ts:11` all import from `a3p-parser`.
