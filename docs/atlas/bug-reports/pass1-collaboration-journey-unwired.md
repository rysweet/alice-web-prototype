...
- `src/server.ts:1-10,21-28` imports and registers only the REST route modules, while `src/index.ts:29` exports `./collaboration` without wiring it into `src/main.ts` or `src/cli.ts`.
