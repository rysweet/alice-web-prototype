...
- `src/server.ts:1-13,38` imports and composes only the REST route modules, while `src/index.ts:29` exports `./collaboration` without wiring it into `src/main.ts` or `src/cli.ts`.
